...
function showSummary() {
    ...
    modal.innerHTML = `
        <div class="summary-content">
            <h2 class="main-title">Résumé du formulaire</h2>
            ...
            <div class="summary-buttons">
                <button class="submit-btn" onclick="confirmSubmission()">
...
function confirmSubmission() {
    closeModal(document.querySelector('.summary-modal'));
    showNotification('Enregistrement  réussie !', 'success');
    document.getElementById('registrationForm').reset();
    document.getElementById('photoPreview').src = 'assets/placeholder.png';
}